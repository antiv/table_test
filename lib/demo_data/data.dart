...
class DummyData {
  ...
  static dynamic valueByColumnType(PlutoColumn column) {
    if (column.type.isNumber || column.type.isCurrency) {
      if (column.title.toLowerCase() == 'age')  {
        return faker.randomGenerator.integer(70, min: 20);
      }
      return faker.randomGenerator.decimal(scale: 10000, min: 5000);
      ...
      return column.title.toLowerCase() == 'id'
      ? const Uuid().v4() : faker.person.name();
    }
  }
